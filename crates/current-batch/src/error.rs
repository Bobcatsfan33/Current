...
pub enum BatchError {
    ...
    #[error(transparent)]
    Log(#[from] current_log::LogError),

    #[error(transparent)]
    ZSet(#[from] current_zset::ZSetError),

    #[error(transparent)]
    Circuit(#[from] current_circuit::CircuitError),

    #[error(transparent)]
    Sql(#[from] current_sql::SqlError),

    #[error(transparent)]
    Memo(#[from] current_memo::MemoError),
}
