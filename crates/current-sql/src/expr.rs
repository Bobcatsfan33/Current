//! SQL expression → [`current_plan::Expr`] (`docs/SEMANTICS.md` S-13 … S-19).
//!
...
//! waiting to happen.
//!
//! **An aggregate is not a scalar expression.** `current_plan::Expr` has no aggregate variant at
...
use current_plan::plan::{AggFunc, BinOp, Expr};
